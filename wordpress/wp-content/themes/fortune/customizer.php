...
function fortune_customizer( $wp_customize ) {
	...
	$wp_customize->add_control( 'fortune_service_icon'.$i, array(
		...
		'description'=>__('<a href="http://fontawesome.io/icons/" target="_blank">FontAwesome Icons</a>','fortune'),
		'section'  => 'service_section',
	...
	public function render_content() {
		...
		<label style="overflow: hidden; zoom: 1;">
			<div class="col-md-2 col-sm-6 upsell-btn">					
					<a style="margin-bottom:20px;margin-left:20px;" href="http://www.webhuntinfotech.com/webhunt_theme/fortune-premium-39/" target="blank" class="btn btn-success btn"><?php _e('Upgrade to Fortune Premium','fortune'); ?> </a>
			</div>
			<div class="col-md-4 col-sm-6">
				<img class="fortune_img_responsive " src="<?php echo get_template_directory_uri() .'/images/fortune.png'?>">
			</div>			
			<div class="col-md-3 col-sm-6">
				<h3 style="margin-top:10px;margin-left: 20px;text-decoration:underline;color:#333;"><?php echo _e( 'Fortune Premium - Features','fortune'); ?></h3>
					<ul style="padding-top:10px">
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Responsive Design','fortune'); ?> </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Rich Shortcodes','fortune'); ?> </li>						
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('More than 15 Templates','fortune'); ?> </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Custom Widgets','fortune'); ?> </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Pricing Tables','fortune'); ?> </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Redux Options Panel','fortune'); ?> </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('2 types of Service Section','fortune'); ?> </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('3 Different Types of Blog Templates','fortune'); ?> </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('4 Types of Portfolio Templates','fortune'); ?></li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Unlimited Colors Scheme','fortune'); ?></li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Patterns Background','fortune'); ?>   </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('WPML Compatible','fortune'); ?>   </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Woo-commerce Compatible','fortune'); ?>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Portfolio layout with Isotope effect','fortune'); ?> </li>
						<li class="upsell-fortune"> <div class="dashicons dashicons-yes"></div> <?php _e('Translation Ready','fortune'); ?> </li>
